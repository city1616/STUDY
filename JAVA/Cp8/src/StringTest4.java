...
public class StringTest4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("aaa문자열의 인덱스 : source1.indexOf(\"aaa\") : " + source1.indexOf("aaa"));
		...
		System.out.println("source1 문자열이 ddd 문자열로 끝나는지 확인 : source1.endsWith(\"ddd\") : " + source1.endsWith("ddd"));
		
		System.out.println("source1 문자열이 aaa로 시작되는지 확인 : source1.startsWith(\"aaa\") : " + source1.startsWith("aaa"));
		
		System.out.println("source1 문자열에 aaa문자열이 포함되어 있는지를 판단 : " + "source1.contains(\"aaa\") : " + source1.contains("aaa"));
		...
		System.out.println("source1과 source2의 대소문자 무시한 비교 : source1.equalsIgnoreCase(source2) : " + source1.equalsIgnoreCase(source2));
		
		System.out.println("source2 전체를 대문자로 변경 : source2.toUpperCase() : " + source2.toUpperCase());
		
		//System.out.println("source2 : " + source2);
		
		System.out.println("source2를 소문자로 변경 : " + source2.toLowerCase());
		System.out.println();
