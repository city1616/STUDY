...
@interface MBMapMatcherOutput : NSObject

- (nonnull instancetype)initWithMatches:(nonnull NSArray<MBMapMatch *> *)matches
 ...
 */
@property (nonatomic, readonly, nonnull, copy) NSArray<MBMapMatch *> *matches;
