...
- (nonnull instancetype)initWithHost:(nonnull NSString *)host
                    ...
                    navigatorVersion:(nonnull NSString *)navigatorVersion
                      skuTokenSource:(nonnull id<MBSkuTokenSource>)skuTokenSource;
...
@property (nonatomic, readonly, nonnull) id<MBSkuTokenSource> skuTokenSource;
